...
- 대회명은 미확정 상태여서 `MIRAE CUP`을 임시 브랜드로 사용했습니다. 종목은 사용자가 확정한 리그 오브 레전드입니다.
...
이미지와 소스가 모두 포함되어 있어 다른 컴퓨터에서도 실행할 수 있습니다. 인터넷 연결은 Google Fonts 로딩에만 사용됩니다. 인터넷이 없어도 시스템 글꼴로 페이지와 메뉴·FAQ가 동작합니다.
