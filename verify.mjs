...
assert.match(html,/id="bracket"/);
assert.equal([...html.matchAll(/class="bk-match[ "]/g)].length,3);
...
console.log('PASS: anchors, unique IDs, local assets, PNG dimensions, Korean language, heading, 9 organizers, 20 line-up slots, 3 bracket matches, JS syntax.');
